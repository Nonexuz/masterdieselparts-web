...
export function WhatsAppButton() {
  ...
  const hideFloatingButton =
    pathname.startsWith("/produto/") || pathname.startsWith("/admin");
  ...
  return (
    <a
      ...
      className="fixed bottom-4 right-4 z-50 flex h-12 w-12 items-center justify-center rounded-full bg-green-600 text-white shadow-xl transition hover:bg-green-500 sm:bottom-5 sm:right-5 sm:h-auto sm:w-auto sm:gap-3 sm:px-5 sm:py-4"
    >
      <svg
        viewBox="0 0 24 24"
        aria-hidden="true"
